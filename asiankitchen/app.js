...
let koreanButton = document.querySelector("#korean");
let japaneseButton = document.querySelector("#japanese");
let chineseButton = document.querySelector("#chinese");
